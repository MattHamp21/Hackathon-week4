...
Weapon.create(name:'Ace of Spades', type:'Firearm', game:'Destiny 2')
Weapon.create(name:'Exile Greatsword', type:'Sword', game:'Dark Souls 3')
Weapon.create(name:'Le Monarque', type:'Bow', game:'Destiny 2')
Weapon.create(name:'The Master Sword', type:'Sword', game:'The Legend of Zelda')
Weapon.create(name:'The Chaperone', type:'Firearm', game:'Destiny 2')
